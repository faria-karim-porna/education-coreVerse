...
function MainApp() {
            ...
            <div className="row g-4">
              <div className="col-md-6 col-lg-4">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("live-classroom")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-primary-red bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
              ...
              <div className="col-md-6 col-lg-4">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("drawing-tool")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-accent-red bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
                      style={{ width: "64px", height: "64px" }}
                    >
              ...
              <div className="col-md-6 col-lg-4">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("question-maker")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-success bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
                      style={{ width: "64px", height: "64px" }}
                    >
            ...
            <div className="row g-4">
              ...
              <div className="col-md-6 col-lg-3">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("country-flags")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-info bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
                      style={{ width: "64px", height: "64px" }}
                    >
                      <span className="text-info fw-bold">ðŸŒ</span>
                    </div>
              ...
              <div className="col-md-6 col-lg-3">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("interactive-globe")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-primary bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
                      style={{ width: "64px", height: "64px" }}
                    >
                      <span className="text-primary fw-bold">ðŸŒ</span>
                    </div>
              ...
              <div className="col-md-6 col-lg-3">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("scientific-calculator")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-warning bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
                      style={{ width: "64px", height: "64px" }}
                    >
                      <span className="text-warning fw-bold">Ï€</span>
                    </div>
              ...
              <div className="col-md-6 col-lg-3">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("unit-converter")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-danger bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
                      style={{ width: "64px", height: "64px" }}
                    >
                      <span className="text-danger fw-bold">â†”ï¸</span>
                    </div>
              ...
              <div className="col-md-6 col-lg-3">
                <div className="card h-100 card-hover" onClick={() => handleNavigate("discussion-forum")}>
                  <div className="card-body p-4 text-center">
                    <div
                      className="bg-secondary bg-opacity-10 rounded-3 d-inline-flex align-items-center justify-content-center mb-3"
                      style={{ width: "64px", height: "64px" }}
                    >
                      <span className="text-secondary fw-bold">ðŸ’¬</span>
                    </div>
  ...
  return (
    <div className="min-vh-100 bg-light-bg d-flex">
      <Sidebar isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} activeView={currentView} onViewChange={handleNavigate} />

      <div className="flex-fill d-flex flex-column overflow-hidden">
        <Header onMenuToggle={() => setIsSidebarOpen(!isSidebarOpen)} isSidebarOpen={isSidebarOpen} onNavigate={handleNavigate} />

        <main className="flex-fill overflow-auto p-3">{renderContent()}</main>
      </div>
    </div>
  );
}
