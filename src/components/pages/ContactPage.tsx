  ...
  const faqs = [
    {
      ...
      answer: 'Getting started is easy! Simply sign up for a free account, choose your role (student or educator), and begin exploring our platform. We offer a comprehensive onboarding process to help you get familiar with all features.'
    },
    {
      question: 'What devices and browsers are supported?',
      answer: 'CoreVerse works on all modern devices including desktops, laptops, tablets, and smartphones. We support Chrome, Firefox, Safari, and Edge browsers. For the best experience with 3D simulations, we recommend using a desktop or laptop.'
    },
    {
      question: 'Is there a mobile app available?',
      answer: 'Yes! Our mobile apps are available for both iOS and Android devices. You can download them from the App Store or Google Play Store. The mobile app includes most features with an optimized interface for smaller screens.'
    },
    {
      question: 'How much does CoreVerse cost?',
      answer: 'We offer flexible pricing plans including a free tier for individual students, affordable plans for educators, and enterprise solutions for institutions. Visit our pricing page for detailed information about each plan.'
    },
    {
      question: 'Can I integrate CoreVerse with my existing LMS?',
      answer: 'Absolutely! CoreVerse integrates seamlessly with popular Learning Management Systems like Canvas, Blackboard, Moodle, and others. We support SSO, grade passback, and roster synchronization.'
    },
    {
      question: 'What kind of support do you provide?',
      answer: 'We provide comprehensive support including 24/7 email support, live chat during business hours, video tutorials, documentation, and webinar training sessions. Enterprise customers also get dedicated account managers.'
    },
    {
      question: 'Is my data secure on CoreVerse?',
      answer: 'Yes, security is our top priority. We use enterprise-grade encryption, comply with FERPA and GDPR regulations, and undergo regular security audits. Your data is stored securely and never shared with third parties.'
    },
    {
      question: 'Can I try CoreVerse before purchasing?',
      answer: 'Definitely! We offer a 30-day free trial for all our paid plans. No credit card required. You can also schedule a personalized demo with our team to see how CoreVerse can benefit your specific needs.'
    }
  ];
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="lead mb-5 mx-auto" style={{ maxWidth: '600px' }}>
                Have questions about CoreVerse? We're here to help! Reach out to our 
                support team or explore our comprehensive FAQ section.
              </p>
                ...
                >
                  <Card hover className="text-center h-100">
                    <div className="card-body p-4">
                      <div className={`${method.color} rounded-circle d-inline-flex align-items-center justify-content-center mb-4`}
      ...
      <section className="py-5 bg-white">
        <div className="container-lg">
          ...
          >
            ...
            <p className="lead text-muted">
              Find quick answers to common questions about CoreVerse
            </p>
          </motion.div>
