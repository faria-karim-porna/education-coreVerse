...
import { Beaker, Atom, Microscope, Calculator, Globe, Languages, MapPin, Palette, CheckCircle, Star } from "lucide-react";
    ...
    <section id="subjects" className="py-5 bg-light-bg position-relative overflow-hidden">
      <div className="container-lg">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-5">
          ...
          <h2 className="display-4 fw-bold text-deep-red mb-4">Master Every Subject</h2>
          <p className="lead text-muted mx-auto" style={{ maxWidth: "700px" }}>
            Dive deep into interactive learning experiences across all major academic disciplines. From cutting-edge STEM simulations to
            creative arts tools.
          </p>
        </motion.div>
                  ...
                  <div className="row g-0 h-100">
                    <div className="col-md-5">
                      <div className="position-relative h-100">
                        <img src={subject.image} alt={subject.title} className="w-100 h-100 object-fit-cover" />
                        <div
                          className={`position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center text-white bg-gradient-to-br ${subject.color} bg-opacity-90`}
                        >
                          <div className="position-absolute top-0 end-0 p-3">
                            <span className="badge bg-white bg-opacity-20 text-deep-red small">{subject.students} students</span>
                          </div>
                          <div className="text-center">
                            <div
                              className="bg-white subject-wise-icon bg-opacity-20 rounded-circle d-inline-flex align-items-center justify-content-center mb-3"
                    ...
                    <div className="col-md-7">
                      <div className="card-body p-4 h-100 d-flex flex-column">
                        ...
                        <div className="mt-4 d-flex gap-2 justify-content-center">
                          <Button variant="primary" size="sm" className="px-4" onClick={() => onNavigate("dashboard")}>
                            Start Learning
                          </Button>
                        </div>
                      </div>
